...
INSERT INTO users (first_name, last_name, email, password, enabled) VALUES
                                                                        ('Иван', 'Иванов', 'ivanov@mail.com', '123456', true),
                                                                        ('Петр', 'Петров', 'petrov@mail.com', 'qwerty', true),
                                                                        ('Сидор', 'Сидоров', 'sidorov@mail.com', 'secret', true);
...
-- Добавляем команды
INSERT INTO teams (name, description, project_id, manager_id) VALUES
